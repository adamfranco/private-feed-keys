...
This plugin is similar in concept to the "Feed Key" plugin (http://code.andrewhamilton.net/wordpress/plugins/feed-key/), but designed from the ground up to operate in a multi-site context where access is controlled by the "More Privacy Options" plugin.
